...
#define PTN_SWAP_LIST                   PTN_XBL, PTN_XBL_CFG, "abl", "devcfg", "dsp", "dtbo", "featenabler", "hyp", "imagefv", "keymaster", "qupfw", "rpm", "tz", "uefisecapp", "vbmeta", "vbmeta_system", "vendor_boot"
#define AB_PTN_LIST PTN_SWAP_LIST, "bluetooth", "boot", "modem", "odm", "product", "system", "system_ext", "vendor"
